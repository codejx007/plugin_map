...
/** FlutterPluginMapPlugin */
public class FlutterPluginMapPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public void onAttachedToActivity(@NonNull ActivityPluginBinding binding) {
    ...
    platformViewRegistry.registerViewFactory("com.example.flutter_plugin_map/mapview", new AmapViewFactory(messenger, activity));
  }
